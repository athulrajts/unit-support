...
namespace System.Units
{
    ...
    public partial struct MagneticFlux : IQuantity<MagneticFluxUnit>, IEquatable<MagneticFlux>, IComparable, IComparable<MagneticFlux>, IConvertible, IFormattable
    {
        ...
        static MagneticFlux()
        {
            BaseDimensions = new Dimensions(2, 1, -2, -1, 0, 0, 0);
        ...
        ///     The <see cref="Dimensions" /> of this quantity.
        /// </summary>
        public Dimensions Dimensions => MagneticFlux.BaseDimensions;
        ...
        {
            return UnitParser.Default.TryParse<MagneticFluxUnit>(str, provider, out unit);
        }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            if(conversionType == typeof(MagneticFlux))
                ...
                return QuantityType.MagneticFlux;
