...
namespace System.Units
{
    ...
    public partial struct Volume : IQuantity<VolumeUnit>, IEquatable<Volume>, IComparable, IComparable<Volume>, IConvertible, IFormattable
    {
        ...
        static Volume()
        {
            BaseDimensions = new Dimensions(3, 0, 0, 0, 0, 0, 0);
            ...
            Info = new QuantityInfo<VolumeUnit>("Volume",
                new UnitInfo<VolumeUnit>[] {
                    ...
                    new UnitInfo<VolumeUnit>(VolumeUnit.CubicMeter, new BaseUnits(length: LengthUnit.Meter)),
        ...
        ///     The <see cref="Dimensions" /> of this quantity.
        /// </summary>
        public Dimensions Dimensions => Volume.BaseDimensions;
