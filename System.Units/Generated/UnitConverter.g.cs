...
namespace System.Units
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRate.BaseUnit, ForceChangeRateUnit.KilopoundForcePerMinute, q => q.ToUnit(ForceChangeRateUnit.KilopoundForcePerMinute));
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRateUnit.KilopoundForcePerMinute, ForceChangeRate.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRate.BaseUnit, ForceChangeRateUnit.KilopoundForcePerSecond, q => q.ToUnit(ForceChangeRateUnit.KilopoundForcePerSecond));
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRateUnit.KilopoundForcePerSecond, ForceChangeRate.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRate.BaseUnit, ForceChangeRateUnit.PoundForcePerMinute, q => q.ToUnit(ForceChangeRateUnit.PoundForcePerMinute));
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRateUnit.PoundForcePerMinute, ForceChangeRate.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRate.BaseUnit, ForceChangeRateUnit.PoundForcePerSecond, q => q.ToUnit(ForceChangeRateUnit.PoundForcePerSecond));
            unitConverter.SetConversionFunction<ForceChangeRate>(ForceChangeRateUnit.PoundForcePerSecond, ForceChangeRate.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.FootOfElevation, q => q.ToUnit(PressureUnit.FootOfElevation));
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MeterOfElevation, q => q.ToUnit(PressureUnit.MeterOfElevation));
            ...
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, q => q.ToUnit(PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, q => q.ToUnit(PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.MegapoundForcePerSquareInchPerMinute, q => q.ToUnit(PressureChangeRateUnit.MegapoundForcePerSquareInchPerMinute));
            ...
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.PoundForcePerSquareInchPerMinute, q => q.ToUnit(PressureChangeRateUnit.PoundForcePerSquareInchPerMinute));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.PoundForcePerSquareInchPerMinute, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.PoundForcePerSquareInchPerSecond, q => q.ToUnit(PressureChangeRateUnit.PoundForcePerSquareInchPerSecond));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.PoundForcePerSquareInchPerSecond, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicFootPerHour, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicFootPerHour));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicFootPerHour, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicFootPerMinute, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicFootPerMinute));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicFootPerMinute, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicFootPerSecond, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicFootPerSecond));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicFootPerSecond, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicMeterPerDay, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicMeterPerDay));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicMeterPerDay, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicMeterPerHour, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicMeterPerHour));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicMeterPerHour, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardCubicMeterPerMinute, q => q.ToUnit(StandardVolumeFlowUnit.StandardCubicMeterPerMinute));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardCubicMeterPerMinute, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlow.BaseUnit, q => q);
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlow.BaseUnit, StandardVolumeFlowUnit.StandardLiterPerMinute, q => q.ToUnit(StandardVolumeFlowUnit.StandardLiterPerMinute));
            unitConverter.SetConversionFunction<StandardVolumeFlow>(StandardVolumeFlowUnit.StandardLiterPerMinute, StandardVolumeFlow.BaseUnit, q => q.ToBaseUnit());
