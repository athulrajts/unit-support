...
namespace System.Units
{
    public class QuantityInfo
    {
        ...
        /// </summary>
        public Dimensions BaseDimensions { get; }
    }
    ...
    {
        /// <inheritdoc />
        public QuantityInfo(string name, UnitInfo<TUnit>[] unitInfos, TUnit baseUnit, IQuantity<TUnit> zero, Dimensions baseDimensions,
            QuantityType quantityType = QuantityType.Undefined)
