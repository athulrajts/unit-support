    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("zh-CN", typeof(AreaUnit), (int)AreaUnit.SquareKilometer, new string[]{"平方公里"}),
                ...
                ("zh-CN", typeof(AreaUnit), (int)AreaUnit.SquareMicrometer, new string[]{"平方微米"}),
                ...
                ("zh-CN", typeof(AreaUnit), (int)AreaUnit.SquareNauticalMile, new string[]{"平方海里"}),
                ...
                ("en-US", typeof(ElectricCurrentGradientUnit), (int)ElectricCurrentGradientUnit.AmperePerMicrosecond, new string[]{"A/μs"}),
                ("en-US", typeof(ElectricCurrentGradientUnit), (int)ElectricCurrentGradientUnit.AmperePerMillisecond, new string[]{"A/ms"}),
                ("en-US", typeof(ElectricCurrentGradientUnit), (int)ElectricCurrentGradientUnit.AmperePerNanosecond, new string[]{"A/ns"}),
                ...
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.KilopoundForcePerMinute, new string[]{"kipf/min", "kip/min", "k/min"}),
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.KilopoundForcePerSecond, new string[]{"kipf/s", "kip/s", "k/s"}),
                ...
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.PoundForcePerMinute, new string[]{"lbf/min"}),
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.PoundForcePerSecond, new string[]{"lbf/s"}),
                ...
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.Gigahertz, new string[]{"ГГц"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.Hertz, new string[]{"Hz"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.Hertz, new string[]{"Гц"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.Kilohertz, new string[]{"kHz"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.Kilohertz, new string[]{"кГц"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.Megahertz, new string[]{"MHz"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.Megahertz, new string[]{"МГц"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.PerSecond, new string[]{"s⁻¹"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.PerSecond, new string[]{"с⁻¹"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.RadianPerSecond, new string[]{"rad/s"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.RadianPerSecond, new string[]{"рад/с"}),
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.Terahertz, new string[]{"THz"}),
                ("ru-RU", typeof(FrequencyUnit), (int)FrequencyUnit.Terahertz, new string[]{"ТГц"}),
                ...
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.Hectometer, new string[]{"百米"}),
                ...
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.Microinch, new string[]{"微英寸"}),
                ...
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.Micrometer, new string[]{"微米"}),
                ("en-US", typeof(LengthUnit), (int)LengthUnit.Mil, new string[]{"mil"}),
                ("ru-RU", typeof(LengthUnit), (int)LengthUnit.Mil, new string[]{"мил"}),
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.Mil, new string[]{"密耳"}),
                ...
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.Nanometer, new string[]{"纳米"}),
                ...
                ("zh-CN", typeof(LengthUnit), (int)LengthUnit.NauticalMile, new string[]{"纳米"}),
                ...
                ("en-US", typeof(MagneticFieldUnit), (int)MagneticFieldUnit.Milligauss, new string[]{"mG"}),
                ...
                ("zh-CN", typeof(MassUnit), (int)MassUnit.Hectogram, new string[]{"百克"}),
                ...
                ("zh-CN", typeof(MassUnit), (int)MassUnit.Kilopound, new string[]{"千磅"}),
                ("en-US", typeof(MassUnit), (int)MassUnit.Kilotonne, new string[]{"kt"}),
                ("ru-RU", typeof(MassUnit), (int)MassUnit.Kilotonne, new string[]{"кт"}),
                ("zh-CN", typeof(MassUnit), (int)MassUnit.Kilotonne, new string[]{"千吨"}),
                ...
                ("zh-CN", typeof(MassUnit), (int)MassUnit.LongTon, new string[]{"长吨"}),
                ...
                ("zh-CN", typeof(MassUnit), (int)MassUnit.ShortTon, new string[]{"短吨"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.FootOfElevation, new string[]{"ft of elevation"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.KilopoundForcePerSquareInch, new string[]{"ksi", "kipf/in²"}),
                ("ru-RU", typeof(PressureUnit), (int)PressureUnit.KilopoundForcePerSquareInch, new string[]{"ksi", "kipf/in²"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.MeterOfElevation, new string[]{"m of elevation"}),
                ...
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, new string[]{"ksi/min", "kipf/in²/min"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, new string[]{"ksi/мин", "kipf/in²/мин"}),
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, new string[]{"ksi/s", "kipf/in²/s"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, new string[]{"ksi/с", "kipf/in²/с"}),
                ...
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.MegapoundForcePerSquareInchPerMinute, new string[]{"Mpsi/min", "Mlb/in²/min"}),
                ...
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.PoundForcePerSquareInchPerMinute, new string[]{"psi/min", "lb/in²/min"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.PoundForcePerSquareInchPerMinute, new string[]{"psi/мин", "lb/in²/мин"}),
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.PoundForcePerSquareInchPerSecond, new string[]{"psi/s", "lb/in²/s"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.PoundForcePerSquareInchPerSecond, new string[]{"psi/с", "lb/in²/с"}),
                ...
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicCentimeterPerMinute, new string[]{"sccm"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicFootPerHour, new string[]{"scfh"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicFootPerMinute, new string[]{"scfm"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicFootPerSecond, new string[]{"Sft³/s"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicMeterPerDay, new string[]{"Sm³/d"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicMeterPerHour, new string[]{"Sm³/h"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicMeterPerMinute, new string[]{"Sm³/min"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardCubicMeterPerSecond, new string[]{"Sm³/s"}),
                ("en-US", typeof(StandardVolumeFlowUnit), (int)StandardVolumeFlowUnit.StandardLiterPerMinute, new string[]{"slm"}),
                ...
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.CubicMeterPerMinute, new string[]{"м³/мин"}),
                ...
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.DeciliterPerMinute, new string[]{"дл/мин"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.DeciliterPerSecond, new string[]{"dL/s", "dLPS"}),
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.DeciliterPerSecond, new string[]{"дл/c"}),
                ...
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.KiloliterPerMinute, new string[]{"кл/мин"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.KiloliterPerSecond, new string[]{"kL/s", "kLPS"}),
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.KiloliterPerSecond, new string[]{"кл/c"}),
                ...
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.LiterPerMinute, new string[]{"л/мин"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.LiterPerSecond, new string[]{"L/s", "LPS"}),
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.LiterPerSecond, new string[]{"л/c"}),
                ...
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.MicroliterPerMinute, new string[]{"мкл/мин"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.MicroliterPerSecond, new string[]{"µL/s", "µLPS"}),
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.MicroliterPerSecond, new string[]{"мкл/c"}),
                ...
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.NanoliterPerSecond, new string[]{"nL/s", "nLPS"}),
                ("ru-RU", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.NanoliterPerSecond, new string[]{"нл/c"}),
